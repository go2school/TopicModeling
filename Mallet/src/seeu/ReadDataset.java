...
public class ReadDataset {
	...
	public static void main(String[] args) throws IOException {
		...
		String fname = "/media/DataVolume1/datasets/20news/new_dataset/5_folds/20_news_0_fold_mallet_train_text.mallet";
		...
		PrintWriter pw = new PrintWriter(new FileWriter("/media/DataVolume1/datasets/20news/new_dataset/20_news_text.voc_train"));
		pw.print(voctext);
		pw.flush();
		pw.close();
