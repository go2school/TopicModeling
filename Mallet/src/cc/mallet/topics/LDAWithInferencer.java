...
public class LDAWithInferencer implements Serializable {
	...
	public LDAWithInferencer (int numberOfTopics)
	{
		this (numberOfTopics, 50.0, 0.01);
	}

	public LDAWithInferencer (int numberOfTopics, double alphaSum, double beta)
	{
...
*/
  ...
  // Serialization
	...
	*
	* added by Xiao 11172012 for topic inference
	*/
	...
	{
		args = new String [3];
		//args[0] =  "D:/mallet-2.0.7/workspace/topic-input.mallet";
		args[0] =  "D:/mallet-2.0.7/workspace/sample.mallet";
		args[1] = "100";
		args[2] = "10";		
		...
		LDAWithInferencer lda = new LDAWithInferencer (2);
		...
		*/
	    ...
	    for (int di = 0; di < numDocs; di++) {
	      ...
	      for(int si=0;si<seqLen;si++)
	      {
	    	  ...
	    	  System.out.println(di + " " + si + " " + t + " " + ilist.getDataAlphabet().lookupObject(t));
	      }
	    }
