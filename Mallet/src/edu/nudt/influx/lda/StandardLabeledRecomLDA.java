 ...
 * 本实验采用标准Ｌ－ＬＤＡ方法进行训练，得到word-label的分布，然后利用此分布采用我们的方法实现tag推荐
 * 对测试集中的文档进行自动标注，以比较Ｌ－ＬＤＡ和ＭＬ－ＬＤＡ的优劣
 */
...
//        lda.printLabelWordDistribution("F:\\Experiment\\LDA\\recSys\\result\\ourMethod2\\wordLabelDistr\\200\\training_label_word_distribution.txt");
        ...
        String  testLabel= "F:\\Experiment\\LDA\\IEICE\\result\\testLabels\\testLabels_SL_500\\";
        String wordLabelDistr="F:\\Experiment\\LDA\\IEICE\\result\\wordLabelDistr\\wordLabelDistr_SL_500\\";
        int labelNum=30;
